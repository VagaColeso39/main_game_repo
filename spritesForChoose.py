...
def change_settings(gameType:str) -> None:
    global curCard
    global cards
    global cards_keys
    if gameType == "stones":
        settings['CardsPerPlayer'] = 6
        settings['gameType'] = gameType
        settings['cardsAmount'] = 24
    elif gameType == "geographic":
        settings['CardsPerPlayer'] = 10
        settings['gameType'] = gameType
        settings['cardsAmount'] = 48

    curCard = settings['CardsPerPlayer']
...
class Player(pg.sprite.Sprite):
    def __init__(self, cards):
        pg.sprite.Sprite.__init__(self)
        self.score = 0
        self.cardsLeft = settings['CardsPerPlayer']
        self.cards = []
        for i in range(1, settings['CardsPerPlayer']):
